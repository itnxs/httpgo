...
func Test_stat_appendCode(t *testing.T) {
    t.Parallel()
...
func Test_stat_writeProcessBar(t *testing.T) {
    t.Parallel()
...
func Test_stat_writeTotalRequest(t *testing.T) {
    t.Parallel()
...
func Test_stat_writeElapsed(t *testing.T) {
    t.Parallel()
...
func Test_stat_writeThroughput(t *testing.T) {
    t.Parallel()
...
func Test_stat_writeErrors(t *testing.T) {
    t.Parallel()

    tt := newStat()
    tt.errs["custom-error"] = 1
    tt.writeErrors()
    assert.Contains(t, tt.buf.String(), lipgloss.NewStyle().Underline(true).Render("custom-error"))
    assert.Contains(t, tt.buf.String(), "1")
}

func Test_stat_writeHint(t *testing.T) {
    t.Parallel()
...
func Test_stat_writeInt(t *testing.T) {
    t.Parallel()
...
func Test_stat_Update(t *testing.T) {
    t.Parallel()
    ...
    for _, tc := range testCases {
        t.Run(tc.name, func(t *testing.T) {
            ...
            err := tea.NewProgram(tt, tea.WithInput(os.Stdin), tea.WithOutput(io.Discard)).Start()
            assert.Nil(t, err)
        })
    }
}
